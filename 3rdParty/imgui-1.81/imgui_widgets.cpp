...
#pragma warning (disable: 4196)     // condition expression is constant
#pragma warning (disable: 4189)     // 'This function or variable may be unsafe': strcpy, strdup, sprintf, vsnprintf, sscanf, fopen
